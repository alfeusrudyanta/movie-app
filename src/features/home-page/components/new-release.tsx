  ...
  return (
    <div className='md:mx-11xl mx-4'>
      <div className='flex flex-col gap-6 md:gap-10'>
        ...
        <div className='grid grid-cols-[repeat(auto-fill,minmax(150px,auto))] gap-x-4 gap-y-8 md:grid-cols-[repeat(auto-fill,minmax(200px,auto))] md:gap-x-4 md:gap-y-10'>
